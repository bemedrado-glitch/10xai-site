...
export const siteCopy = {
  en: {
    ...
    systems: [
      ...
      { name: "Automated booking and customer service for dentists", audience: "Dental clinics, healthcare operators, front-desk teams", trigger: "Revenue slips between inquiries, booking, reminders, cancellations, and repetitive service questions.", story: "Build a patient-facing booking and service layer that keeps chairs full and reduces front-desk overload.", outcome: "More appointments get booked and the staff can focus on patients instead of repetitive coordination work.", urgency: "Slow booking and weak reminder systems create visible revenue leakage and a weaker patient experience.", bullets: ["Booking and reminders", "Patient FAQ support", "Operational workflows for the front desk"] }
    ],
  ...
  pt: {
    ...
    systems: [
      ...
      { name: "Agendamento automatizado e atendimento para clinicas odontologicas", audience: "Clinicas odontologicas, operadores de saude, recepcao", trigger: "A receita escapa entre contatos, agendamentos, lembretes, cancelamentos e perguntas repetitivas.", story: "Crie uma camada de agendamento e atendimento que mantem cadeiras ocupadas e reduz a sobrecarga da recepcao.", outcome: "Mais consultas sao agendadas e a equipe foca em pacientes em vez de coordenacao repetitiva.", urgency: "Agendamento lento e lembretes fracos geram vazamento visivel de receita e pior experiencia do paciente.", bullets: ["Agendamento e lembretes", "Suporte para perguntas frequentes", "Fluxos operacionais para a recepcao"] }
    ],
